...
import { ArrowRight, ShieldCheck, Target, Brain, Award, Newspaper, Dna, Globe, Eye, Shield, Syringe, Gamepad2, Zap, BarChart3 } from "lucide-react"
import { getDictionary, Locale } from "@/lib/get-dictionary"
import { FadeIn, FloatingElement, ScaleIn, StaggerContainer, StaggerItem } from "@/components/InteractiveComponents"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "logo": "https://literaciaedu.com.br/logo/LOGO_%20LITERACIA%20EDU_Prancheta%2015.png",
              ...
              <FloatingElement speed={5}>
                <div className="relative aspect-[4/3] w-full rounded-2xl bg-gradient-to-tr from-primary-teal to-bright-teal p-1 shadow-2xl shadow-primary-teal/20 overflow-hidden group">
                  ...
                  <div className="w-full h-full bg-[#05242A] relative flex items-center justify-center">
                    ...
                    <div className="relative w-40 h-40 opacity-80 transition-transform duration-300 group-hover:scale-105">
                      <Image
                        src="/logo/LOGO_ LITERACIA EDU_Prancheta 03.png"
